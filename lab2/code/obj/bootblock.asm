...
protcseg:
    ...
    call bootmain
    7c85:	e8 9c 00 00 00       	call   7d26 <bootmain>
...
readseg(uintptr_t va, uint32_t count, uint32_t offset) {
    7c9c:	89 ce                	mov    %ecx,%esi
    7c9e:	53                   	push   %ebx
    va -= offset % SECTSIZE;
    7c9f:	29 d0                	sub    %edx,%eax

    // translate from bytes to sectors; kernel starts at sector 1
    uint32_t secno = (offset / SECTSIZE) + 1;
    7ca1:	c1 ee 09             	shr    $0x9,%esi
readseg(uintptr_t va, uint32_t count, uint32_t offset) {
    7ca4:	53                   	push   %ebx
    va -= offset % SECTSIZE;
    7ca5:	89 c3                	mov    %eax,%ebx
    uintptr_t end_va = va + count;
    7ca7:	89 7d f0             	mov    %edi,-0x10(%ebp)
    ...
    7cae:	73 70                	jae    7d20 <readseg+0x94>
...
outb(uint16_t port, uint8_t data) {
    ...
    7d1e:	eb 8a                	jmp    7caa <readseg+0x1e>
...
void
bootmain(void) {
    7d26:	f3 0f 1e fb          	endbr32 
    7d2a:	55                   	push   %ebp
    // read the 1st page off disk
    readseg((uintptr_t)ELFHDR, SECTSIZE * 8, 0);
    7d2b:	31 c9                	xor    %ecx,%ecx
    7d2d:	ba 00 10 00 00       	mov    $0x1000,%edx
    7d32:	b8 00 00 01 00       	mov    $0x10000,%eax
bootmain(void) {
    7d37:	89 e5                	mov    %esp,%ebp
    7d39:	56                   	push   %esi
    7d3a:	53                   	push   %ebx
    readseg((uintptr_t)ELFHDR, SECTSIZE * 8, 0);
    7d3b:	e8 4c ff ff ff       	call   7c8c <readseg>

    // is this a valid ELF?
    if (ELFHDR->e_magic != ELF_MAGIC) {
    7d40:	81 3d 00 00 01 00 7f 	cmpl   $0x464c457f,0x10000
    7d47:	45 4c 46 
    7d4a:	75 3f                	jne    7d8b <bootmain+0x65>
    }
    ...
    7d51:	0f b7 35 2c 00 01 00 	movzwl 0x1002c,%esi
    ph = (struct proghdr *)((uintptr_t)ELFHDR + ELFHDR->e_phoff);
    ...
    7d65:	73 18                	jae    7d7f <bootmain+0x59>
        readseg(ph->p_va & 0xFFFFFF, ph->p_memsz, ph->p_offset);
    7d67:	8b 43 08             	mov    0x8(%ebx),%eax
    7d6a:	8b 4b 04             	mov    0x4(%ebx),%ecx
    for (; ph < eph; ph ++) {
    7d6d:	83 c3 20             	add    $0x20,%ebx
        readseg(ph->p_va & 0xFFFFFF, ph->p_memsz, ph->p_offset);
    7d70:	8b 53 f4             	mov    -0xc(%ebx),%edx
    7d73:	25 ff ff ff 00       	and    $0xffffff,%eax
    7d78:	e8 0f ff ff ff       	call   7c8c <readseg>
    7d7d:	eb e4                	jmp    7d63 <bootmain+0x3d>
    }

    // call the entry point from the ELF header
    // note: does not return
    ((void (*)(void))(ELFHDR->e_entry & 0xFFFFFF))();
    7d7f:	a1 18 00 01 00       	mov    0x10018,%eax
    7d84:	25 ff ff ff 00       	and    $0xffffff,%eax
    7d89:	ff d0                	call   *%eax
}
...
outw(uint16_t port, uint16_t data) {
    ...
    7d8b:	ba 00 8a ff ff       	mov    $0xffff8a00,%edx
    7d90:	89 d0                	mov    %edx,%eax
    7d92:	66 ef                	out    %ax,(%dx)
    7d94:	b8 00 8e ff ff       	mov    $0xffff8e00,%eax
    7d99:	66 ef                	out    %ax,(%dx)
    7d9b:	eb fe                	jmp    7d9b <bootmain+0x75>
